...
<body>
	...
	<div class="container">
		<h2 class="mx-auto" style="width: 250px;">新規会員登録</h2>
		...
		<form action="Createuser"method="post">
			...
			都道府県(必須)<br>
			<!-- ▼住所入力フィールド(都道府県) -->
			<select name="pref31" required value=<c:if test="${pref31 != null}" >${pref31}</c:if>>
			...
			電話番号(必須)<br>
			<input type="text" name=phone required value=<c:if test="${phone != null}" >${phone}</c:if>><br><br>
			<input type="submit" class="btn btn-success max" value="入力情報を確認する">
		</form>
	</div>
