...
<body>
	...
	<div class="container">
		...
		<br>
		<form action="Createuserverify" method="post">
		<table class="table table-striped">
			<tr>
				<th>ユーザ名</th>
				<td><input type="text" class="boxhidden max"name="userIdName" value="${userIdName}" readonly></td>
			</tr>
			<tr>
				<th>メールアドレス</th>
			...
			<tr>
				<th>お名前</th>
				<td><input type="text" class="boxhidden max" name="userName" value="${userName}" readonly></td>
			</tr>
			<tr>
				<th>郵便番号</th>
